...
const HowItWorks = () => {
  ...
  <section id="how-it-works" className="py-40 flex flex-col justify-center items-center text-center" style={{ backgroundColor: '#F9F6F2', minHeight: '200px', paddingTop: '10rem' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        <div
          className="howitworks-steps flex flex-row items-center justify-center gap-8 mb-16 w-full"
          ...
          {steps.map((step, index) => (
            <React.Fragment key={index}>
              <div
                ...
                className="text-center group min-w-[220px]"
              >
                <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center relative">
                  ...
                  />
                  <div
                    className="w-16 h-16 border-2 transform rotate-45 flex items-center justify-center bg-white transition-colors relative"
                    style={{ borderColor: '#0A2240', zIndex: 1 }}
                  >
                    <div
              ...
              {index < steps.length - 1 && (
                <div className="howitworks-arrow flex items-center justify-center mx-2">
                  <i className="fas fa-arrow-right text-2xl text-gray-400 md:inline hidden"></i>
                  <i className="fas fa-arrow-down text-2xl text-gray-400 md:hidden"></i>
                </div>
              )}
            </React.Fragment>
          ))}
